...
<p class="forumnav"><a href="/[\w]+/forums/">Forums</a>   » <a dir="ltr" href="/community/forums/tgr.dml\?id=([0-9]*)">(.*?)</a>  » <a href="forum\.dml\?id=([0-9]+)">(.*?)</a></p>
	...
	forum_category_id = xstr(metadata.group(2))
	...
	for comment in comments:
		...
		# Write log if forum_category_id is missing
		if forum_category_id is '':
			log(comment_id + ' malfunction. Missing forum_category_id')
